...
namespace ArticleService.Database.Migrations
{
    ...
    [Migration("20240420121831_users_info")]
    partial class users_info
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArticleService.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("06623b29-6c65-7449-8000-814f6d606bd7"),
                            Name = "User"
                        },
                        new
                        {
                            Id = new Guid("06623b29-6c65-750b-8000-d1fa800b0302"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("06623b29-6c65-7512-8000-853a0188cf59"),
                            Name = "Moderator"
                        });
                });
