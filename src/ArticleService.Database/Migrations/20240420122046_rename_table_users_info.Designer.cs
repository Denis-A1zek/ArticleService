...
namespace ArticleService.Database.Migrations
{
    ...
    [Migration("20240420122046_rename_table_users_info")]
    partial class rename_table_users_info
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArticleService.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("06623b31-d7b6-7f45-8000-1f8b7eddab1b"),
                            Name = "User"
                        },
                        new
                        {
                            Id = new Guid("06623b31-d7b6-7f7c-8000-d114ad18ef47"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("06623b31-d7b6-7f7f-8000-9efc35546589"),
                            Name = "Moderator"
                        });
                });
